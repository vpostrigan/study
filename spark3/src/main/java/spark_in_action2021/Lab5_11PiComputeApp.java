 ...
 */
public class Lab5_11PiComputeApp implements Serializable {
    private static long counter = 0;

    public static void main(String[] args) {
        Lab5_11PiComputeApp app = new Lab5_11PiComputeApp();
        app.start(10);
    }
    ...
    private void start(int slices) {
        ...
        // [4] свертка
        Integer dartsInCircle = dartsDs.reduce(new DartReducer());
    ...
    private class DartMapper implements MapFunction<Row, Integer> {
        @Override
    ...
    private class DartReducer implements ReduceFunction<Integer> {
        @Override

...
import advanced_java2_deitel.chapter5_graphic_with_mvc.controller.DragAndDropController;
import advanced_java2_deitel.chapter5_graphic_with_mvc.controller.MyShapeController;
import advanced_java2_deitel.chapter5_graphic_with_mvc.controller.MyShapeControllerFactory;
import advanced_java2_deitel.chapter5_graphic_with_mvc.model.DrawingModel;
import advanced_java2_deitel.chapter5_graphic_with_mvc.view.DrawingView;
...
public class DrawingInternalFrame extends JInternalFrame implements Observer {
    ...
    public DrawingInternalFrame(String title) {
        ...
        setMyShapeController(
                shapeControllerFactory.newMyShapeController(drawingModel, shapeName));
    ...
    public void setSaved(boolean drawingSaved) {
        ...
        if (!title.endsWith(" *") && !isSaved())
            ...
            // remove * from title
        else if (title.endsWith(" *") && isSaved())
    ...
    public void setMyShapeController(MyShapeController controller) {
    ...
    public boolean openDrawing() {
        ...
        if (response == fileChooser.APPROVE_OPTION) {
            ...
            Collection shapes = DrawingFileReaderWriter.readFile(fileName);
    ...
    public void saveDrawing() {
        ...
        if (fileName == null || fileName.equals(""))
            ...
            DrawingFileReaderWriter.writeFile(drawingModel, fileName);
    ...
    private class DrawingToolBar extends JToolBar {
        ...
        public DrawingToolBar() {
            ...
            shapeChoice.addActionListener(event -> {
            ...
            strokeSizeChoice.addActionListener(event ->
            ...
            fillAction = new AbstractDrawingAction(
                    "Fill", null, "Fill Shape", new Integer('L')) {
            ...
            primaryColorButton.addActionListener(event -> {
            ...
            secondaryColorButton.addActionListener(event -> {
                Color color = JColorChooser.showDialog(
                        DrawingInternalFrame.this, "Select Color",
            ...
            Icon saveIcon = new ImageIcon(
                    DrawingInternalFrame.class.getResource("save.gif"));

            saveAction = new AbstractDrawingAction(
                    "Save", saveIcon, "Save Drawing", new Integer('S')) {
                @Override
                public void actionPerformed(ActionEvent event) {
                    saveDrawing();
                }
            ...
            Icon saveAsIcon = new ImageIcon(
                    DrawingInternalFrame.class.getResource("saveAs.gif"));

            saveAsAction = new AbstractDrawingAction(
                    "Save As", saveAsIcon, "Save Drawing As", new Integer('A')) {
                @Override
                public void actionPerformed(ActionEvent event) {
                    saveDrawingAs();
                }
            ...
            Icon zoomIcon = new ImageIcon(
                    DrawingInternalFrame.class.getResource("zoom.gif"));

            zoomAction = new AbstractDrawingAction(
                    "Zoom", zoomIcon, "Show Zoom Window", new Integer('Z')) {
                @Override
                public void actionPerformed(ActionEvent event) {
                    showZoomDialog();
                }
            ...
            Icon moveIcon = new ImageIcon(
                    DrawingInternalFrame.class.getResource("move.gif"));

            moveAction = new AbstractDrawingAction(
                    "Move", null, "Move Shape", new Integer('M')) {
                @Override
                public void actionPerformed(ActionEvent event) {

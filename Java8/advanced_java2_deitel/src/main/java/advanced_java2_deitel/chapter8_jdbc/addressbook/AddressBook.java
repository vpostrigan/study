...
// transactions to ensure that the operations complete successfully.
public class AddressBook extends JFrame {
    ...
    // user to input new entry. User must "Save" entry after inputting data.
    ...
    // inner class defines an action that can save new or updated entry
    ...
    private class DeleteAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            // If personID is 0, this is new entry that has not been inserted.
            // Therefore, delete is not necessary.
            // Display message and return.
            if (person.getPersonID() == 0) {
                JOptionPane.showMessageDialog(desktop,
                        "New entries must be saved before they can be deleted. \n" +
    ...
    private class SearchAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            // if last name was input, search for it; otherwise, do nothing
            if (lastName != null) {
                // Execute search. If found, AddressBookEntry is returned containing data.
    ...
    // inner class defines action that closes connection to database and terminates program

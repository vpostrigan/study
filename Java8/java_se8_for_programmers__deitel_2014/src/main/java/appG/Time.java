package appG; // place Time in a package
...
public class Time {
    ...
    /**
     * Set a new time value using universal time. Perform validity checks on the data.
     ...
     *
     * @return a <code>String</code> representation of the time in universal-time format
     */
     ...
     *
     * @return a <code>String</code> representation of the time in standard-time format
     */

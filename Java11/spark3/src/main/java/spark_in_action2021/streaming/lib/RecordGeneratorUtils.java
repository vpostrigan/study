...
public class RecordGeneratorUtils {
    ...
    private RecordGeneratorUtils() throws RecordGeneratorException {
        try {
            femaleFirstNames = Files.readAllLines(new File("data/female_first_names.txt").toPath(), Charset.defaultCharset());
        } catch (IOException e) {
        ...
        try {
            maleFirstNames = Files.readAllLines(new File("data/male_first_names.txt").toPath(), Charset.defaultCharset());
        } catch (IOException e) {
        ...
        try {
            lastNames = Files.readAllLines(new File("data/last_names.txt").toPath(), Charset.defaultCharset());
        } catch (IOException e) {
    ...
    private static String[] nouns = {"Life", "Trip", "Experience", "Work", "Job", "Beach", "Sky"};

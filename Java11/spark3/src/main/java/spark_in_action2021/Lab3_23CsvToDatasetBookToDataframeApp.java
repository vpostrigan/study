 ...
 * @author jgp
 */
public class Lab3_23CsvToDatasetBookToDataframeApp implements Serializable {
    private static final long serialVersionUID = -1L;

    public static void main(String[] args) {
        Lab3_23CsvToDatasetBookToDataframeApp app = new Lab3_23CsvToDatasetBookToDataframeApp();
        app.start();
    }
